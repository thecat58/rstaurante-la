# Generated by Django 5.1.6 on 2025-05-05 12:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pedido', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='app.pedido')),
            ],
            options={
                'db_table': 'factura',
                'managed': True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('menu_id_menu', models.ForeignKey(db_column='menu_id_menu', on_delete=django.db.models.deletion.DO_NOTHING, to='app.menu')),
            ],
            options={
                'db_table': 'plato',
                'managed': True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pedido', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='platos', to='app.pedido')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('plato_id', models.ForeignKey(blank=True, db_column='plato_id', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='app.plato')),
            ],
            options={
