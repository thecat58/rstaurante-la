    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mesa_id_mesa', models.ForeignKey(db_column='mesa_id_mesa', on_delete=django.db.models.deletion.DO_NOTHING, to='app.mesa')),
            ],
            options={
                'db_table': 'pedido',
                'managed': True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nombre', models.CharField(max_length=100)),
                ('descripcion', models.TextField(blank=True, null=True)),
                ('plato_id', models.ForeignKey(db_column='id_plato', on_delete=django.db.models.deletion.DO_NOTHING, to='app.plato')),
            ],
            options={
                'db_table': 'tipoplato',
                'managed': True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pedido', models.ForeignKey(db_column='pedido_id', on_delete=django.db.models.deletion.CASCADE, to='app.pedido')),
                ('plato', models.ForeignKey(db_column='plato_id', on_delete=django.db.models.deletion.CASCADE, to='app.plato')),
            ],
            options={
